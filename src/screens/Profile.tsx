    ...
    <View className="bg-[#09090b] w-screen h-full">
      <View className="p-6">
        ...
        <View className="bg-[#161617] rounded-2xl p-5 gap-5">
          <View className="flex-row items-center justify-between border-b border-[#212123] pb-4">
            <View className="flex-row gap-4 items-start">
              <Feather name="moon" size={24} color="#6784e4" />
              <View>
        ...
        <Text className="text-slate-400 mt-8 mb-3">About</Text>
